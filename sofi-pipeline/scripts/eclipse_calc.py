...
# --- Ortsliste --------------------------------------------------------------
# (slug, Name, Land, lat, lon, Hoehe m, IANA-Zeitzone)
# Bewusst OHNE Kategorie: die wird in build_site_data.py aus den
# gerechneten Werten abgeleitet, damit es nur eine Wahrheit gibt.
PLACES = [
    # Spanien - Provinz Cadiz / Atlantik
    ("tarifa",        "Tarifa",                "Spanien",   36.014, -5.606,   5, "Europe/Madrid"),
    ("cadiz",         "Cádiz",                 "Spanien",   36.529, -6.293,  10, "Europe/Madrid"),
    ("jerez",         "Jerez de la Frontera",  "Spanien",   36.685, -6.126,  55, "Europe/Madrid"),
    ("conil",         "Conil de la Frontera",  "Spanien",   36.277, -6.089,  40, "Europe/Madrid"),
    ("vejer",         "Vejer de la Frontera",  "Spanien",   36.252, -5.965, 190, "Europe/Madrid"),
    ("zahara",        "Zahara de los Atunes",  "Spanien",   36.135, -5.846,   5, "Europe/Madrid"),
    ("algeciras",     "Algeciras",             "Spanien",   36.140, -5.456,  20, "Europe/Madrid"),
    ("gibraltar",     "Gibraltar",             "Gibraltar", 36.140, -5.353,  10, "Europe/Gibraltar"),
    # Spanien - Costa del Sol / Inland
    ("estepona",      "Estepona",              "Spanien",   36.428, -5.146,  20, "Europe/Madrid"),
    ("marbella",      "Marbella",              "Spanien",   36.510, -4.886,  30, "Europe/Madrid"),
    ("fuengirola",    "Fuengirola",            "Spanien",   36.541, -4.625,  10, "Europe/Madrid"),
    ("malaga",        "Málaga",                "Spanien",   36.721, -4.421,  10, "Europe/Madrid"),
    ("ronda",         "Ronda",                 "Spanien",   36.746, -5.161, 740, "Europe/Madrid"),
    ("sevilla",       "Sevilla",               "Spanien",   37.389, -5.984,  10, "Europe/Madrid"),
    ("granada",       "Granada",               "Spanien",   37.177, -3.598, 680, "Europe/Madrid"),
    ("almeria",       "Almería",               "Spanien",   36.834, -2.464,  20, "Europe/Madrid"),
    ("ceuta",         "Ceuta",                 "Spanien",   35.889, -5.316,  10, "Africa/Ceuta"),
    ("melilla",       "Melilla",               "Spanien",   35.292, -2.938,  20, "Africa/Ceuta"),
    ("palma",         "Palma de Mallorca",     "Spanien",   39.570,  2.650,  10, "Europe/Madrid"),
    # Marokko
    ("tanger",        "Tanger",                "Marokko",   35.759, -5.834,  20, "Africa/Casablanca"),
    ("asilah",        "Asilah",                "Marokko",   35.465, -6.035,  10, "Africa/Casablanca"),
    ("tetouan",       "Tétouan",               "Marokko",   35.577, -5.368,  90, "Africa/Casablanca"),
    ("chefchaouen",   "Chefchaouen",           "Marokko",   35.169, -5.264, 560, "Africa/Casablanca"),
    ("al-hoceima",    "Al Hoceïma",            "Marokko",   35.244, -3.931,  40, "Africa/Casablanca"),
    ("nador",         "Nador",                 "Marokko",   35.168, -2.933,  10, "Africa/Casablanca"),
    ("fes",           "Fès",                   "Marokko",   34.033, -5.000, 410, "Africa/Casablanca"),
    # Algerien / Tunesien
    ("oran",          "Oran",                  "Algerien",  35.699, -0.635,  90, "Africa/Algiers"),
    ("algier",        "Algier",                "Algerien",  36.754,  3.059,  20, "Africa/Algiers"),
    ("tunis",         "Tunis",                 "Tunesien",  36.806, 10.181,  10, "Africa/Tunis"),
    ("kairouan",      "Kairouan",              "Tunesien",  35.678, 10.096,  60, "Africa/Tunis"),
    ("sousse",        "Sousse",                "Tunesien",  35.826, 10.637,  10, "Africa/Tunis"),
    ("monastir",      "Monastir",              "Tunesien",  35.778, 10.826,  10, "Africa/Tunis"),
    ("sfax",          "Sfax",                  "Tunesien",  34.740, 10.760,  10, "Africa/Tunis"),
    ("djerba",        "Djerba (Houmt Souk)",   "Tunesien",  33.876, 10.857,   5, "Africa/Tunis"),
    ("lampedusa",     "Lampedusa",             "Italien",   35.502, 12.606,  20, "Europe/Rome"),
    # Libyen
    ("benghazi",      "Bengasi",               "Libyen",    32.117, 20.067,  10, "Africa/Tripoli"),
    # Aegypten
    ("siwa",          "Siwa-Oase",             "Ägypten",   29.204, 25.519, -15, "Africa/Cairo"),
    ("kairo",         "Kairo",                 "Ägypten",   30.044, 31.236,  20, "Africa/Cairo"),
    ("sohag",         "Sohag",                 "Ägypten",   26.556, 31.695,  60, "Africa/Cairo"),
    ("girga",         "Girga",                 "Ägypten",   26.336, 31.891,  65, "Africa/Cairo"),
    ("qena",          "Qena",                  "Ägypten",   26.161, 32.727,  75, "Africa/Cairo"),
    ("luxor",         "Luxor",                 "Ägypten",   25.687, 32.640,  75, "Africa/Cairo"),
    ("hurghada",      "Hurghada",              "Ägypten",   27.258, 33.812,   5, "Africa/Cairo"),
    ("el-gouna",      "El Gouna",              "Ägypten",   27.394, 33.678,   5, "Africa/Cairo"),
    ("safaga",        "Safaga",                "Ägypten",   26.729, 33.936,   5, "Africa/Cairo"),
    ("marsa-alam",    "Marsa Alam",            "Ägypten",   25.063, 34.890,  10, "Africa/Cairo"),
    ("assuan",        "Assuan",                "Ägypten",   24.089, 32.899, 100, "Africa/Cairo"),
    # Saudi-Arabien
    ("dschidda",      "Dschidda",              "Saudi-Arabien", 21.543, 39.173, 10, "Asia/Riyadh"),
    ("mekka",         "Mekka",                 "Saudi-Arabien", 21.389, 39.857, 280, "Asia/Riyadh"),
    # DACH & Referenz (nur partiell) - fuer die "Sichtbarkeit zuhause"-Seiten
    ("zuerich",       "Zürich",                "Schweiz",   47.377,  8.541, 410, "Europe/Zurich"),
    ("bern",          "Bern",                  "Schweiz",   46.948,  7.447, 540, "Europe/Zurich"),
    ("muenchen",      "München",               "Deutschland", 48.137, 11.575, 520, "Europe/Berlin"),
    ("frankfurt",     "Frankfurt am Main",     "Deutschland", 50.110,  8.682, 110, "Europe/Berlin"),
    ("berlin",        "Berlin",                "Deutschland", 52.520, 13.405,  35, "Europe/Berlin"),
    ("wien",          "Wien",                  "Österreich", 48.208, 16.373, 170, "Europe/Vienna"),
    ("rom",           "Rom",                   "Italien",   41.893, 12.483,  20, "Europe/Rome"),
]
...
def circumstances(lat, lon, elev_m):
    ...
    result = {
        ...
        "obscuration_max": round(float(obscuration), 6),
...
def main():
    out = []
    for slug, name, country, lat, lon, elev, tzname in PLACES:
        c = circumstances(lat, lon, elev)
        pc, tc = c["partial_contacts_tt_jd"], c["total_contacts_tt_jd"]

        is_total = len(tc) >= 2

        # Bedeckungsgrad: normal auf 0.1 % gerundet. Fuer Orte knapp AUSSERHALB
        # der Zone wuerde das 99.97 % zu "100.0 %" machen - ein Widerspruch zur
        # Aussage "nicht total". Dort runden wir feiner, statt zu beschoenigen.
        obs_pct = c["obscuration_max"] * 100
        if not is_total and round(obs_pct, 1) >= 100.0:
        ...
        print(f"{name:24s} {country:14s} total={str(rec['is_total']):5s} "
              f"Dauer={tot:9s} Bedeckung={rec["obscuration_pct"]:6.2f}% "
